DROP TABLE IF EXISTS `zone_difficulty_hardmode_creatureoverrides`;
CREATE TABLE `zone_difficulty_hardmode_creatureoverrides` (
...
DELETE FROM `zone_difficulty_hardmode_creatureoverrides`;
